...
// Copyright (c) 2014-2019 The PACCommunity developers
...
/* PaccoinGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 16;

static const bool DEFAULT_SPLASHSCREEN = true;

/* Invalid field background style */
#define STYLE_INVALID "background:#ff4d4d"
...
/* Transaction list c TX status decoration - open until date */
