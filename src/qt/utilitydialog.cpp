...
IMPORTANT: the convertion PAC to USD can have some fluctuation since the value is obtained from an external API and the value is obtained every certain time."));
